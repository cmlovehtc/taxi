...
1. 在 GitHub 開啟 [`TAXI_INSTALLER_V2.cmd`](https://github.com/cmlovehtc/taxi/blob/main/TAXI_INSTALLER_V2.cmd)，按右上方的 **Download raw file** 下載按鈕。這一版使用純英文與 Windows CRLF 格式，可避免傳統命令提示字元把中文檔案讀成亂碼。
2. 在 Windows 的「下載」資料夾找到 `TAXI_INSTALLER_V2.cmd`，點兩下執行。
